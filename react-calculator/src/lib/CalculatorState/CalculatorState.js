...
import {READOUT_MAX_DIGITS, BUTTONS_TO_OP} from "../constants";
...
export default class CalculatorState {
  ...
  getReadout() {
    return parseFloat(this.accumulator1).toLocaleString(undefined, {maximumFractionDigits: READOUT_MAX_DIGITS});
  }
